...
public class Aggregate extends Operator {
    ...
    private final TupleDesc child_td;
    ...
    public String groupFieldName() {
        ...
        return child_td.getFieldName(gbFieldIndex);
    }
    ...
    public String aggregateFieldName() {
        // some code goes here
        return child_td.getFieldName(aFieldIndex);
    }
    ...
    public TupleDesc getTupleDesc() {
        // some code goes here
        //返回聚合元组的TupleDesc,类型和名字根据child、gbFieldIndex、aFieldIndex确定
        if (td != null) {
            return td;
        }
        Type[] types;
        ...
        if (gbFieldIndex == Aggregator.NO_GROUPING) {
            ...
            names = new String[]{aggregateFieldName()};
        } else {
            types = new Type[]{gbFieldType, Type.INT_TYPE};
            names = new String[]{groupFieldName(), aggregateFieldName()};
        }
